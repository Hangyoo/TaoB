...
if __name__ == '__main__':
    ...
    df1.to_csv('./Result/Variable_NSGA3.csv', header=None, index=None)
    df2.to_csv('./Result/Objective_NSGA3.csv', header=None, index=None)
    ...
    ax1.scatter3D([x[0] for x in Objective_temp], [x[1] for x in Objective_temp], [x[2] for x in Objective_temp], c='green', marker='*', s=35)
