...
if __name__ == '__main__':
    ...
    df1.to_csv('./Result/Variable_NSGA2.csv', header=None, index=None)
    df2.to_csv('./Result/Objective_NSGA2.csv', header=None, index=None)
    ...
    ax1.scatter3D([x[0] for x in Objective_temp], [x[1] for x in Objective_temp], [x[2] for x in Objective_temp],c='blue', marker='+', s=35)
