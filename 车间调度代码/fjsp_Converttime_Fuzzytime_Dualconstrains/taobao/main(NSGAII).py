...
if __name__ == '__main__':
    patch = r'C:\Users\DELL\PycharmProjects\fjsp_Converttime_Fuzzytime_Dualconstrains\taobao\Benchmark\Mk05.fjs_fuzzy'
    ...
    gantt_data = decoding.translate_decoded_to_gantt(
        decoding.decode(parameters, best_list[best_idx][0], best_list[best_idx][1], best_list[best_idx][2], convert))
    title = "Dual resource-constrained Flexible Job Shop Solution (NSGA-II)"  # 甘特图title
