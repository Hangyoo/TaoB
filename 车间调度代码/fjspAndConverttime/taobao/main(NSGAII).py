...
if __name__ == '__main__':
    patch = r'C:\Users\Hangyu\PycharmProjects\fjsp_Converttime_Fuzzytime_Dualconstrains\taobao\Benchmark\Mk08.fjs_fuzzy'
    ...
    gantt_data = decoding.translate_decoded_to_gantt(
        decoding.decode(parameters, best_list[0][0], best_list[0][1], convert))
    title = "Flexible Job Shop Solution Consider Fuzzy Processing Time (NSGA-II)"  # 甘特图title (英文)
