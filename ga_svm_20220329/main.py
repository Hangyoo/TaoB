import geatpy as ea
import numpy as np
from ga_svm_20220329.problem import MyProblem
...
if __name__ == '__main__':
    ...
    f_best = np.savetxt("GA_best.txt",myAlgorithm.trace['f_best'])
    # f_avg = np.savetxt("GA_avg.txt",myAlgorithm.trace['f_avg'])
    print(f_best)
    """==================================输出结果=============================="""
