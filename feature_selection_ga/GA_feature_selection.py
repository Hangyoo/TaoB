...
# data = pd.read_csv('./dataset/sonar.all-data',header=None,sep=',') # data set 1
# data = pd.read_csv('./dataset/real_data.csv',header=None,sep=',') # data set 2
data = pd.read_csv('./dataset/iris.data',header=None,sep=',') # data set 3
print(data.head())
