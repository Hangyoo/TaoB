...
with open("RF_model1.pkl","rb") as F1:
    RF_model1 = pickle.load(F1)
with open("RF_model2.pkl", "rb") as F2:
    RF_model2 = pickle.load(F2)
...
for i in range(len(f1)):
    ...
    RF_predict_f1.append(RF_model1.predict(X))
    RF_predict_f2.append(RF_model2.predict(X))
