# This module helps creating Gantt from begin dictionary or begin text file.
# Output formats are begin Matplotlib chart or begin LaTeX code (using pgfgantt).
